      ...
      <el-row>
        <el-col :span="12" :offset="6">
          <el-form-item prop="role">
            <el-radio v-model="registerForm.role" label="observer">观察者</el-radio>
            <el-radio v-model="registerForm.role" label="manager">管理者</el-radio>
            <el-radio v-model="registerForm.role" label="administrator">超级管理员</el-radio>
          </el-form-item>
        </el-col>
      </el-row>
